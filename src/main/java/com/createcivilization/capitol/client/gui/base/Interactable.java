...
public interface Interactable {
	...
	class TextInteractable implements Interactable {
		...
		public void render(GuiGraphics guiGraphics) {
			if (isHidden()) return;
			guiGraphics.drawString(Minecraft.getInstance().font, this.title, this.x, this.y, this.color, this.dropShadow);
		}

		@Override
		public BoundingBox getBoundingBox() {
			return new BoundingBox(this.x, this.y, this.x + Minecraft.getInstance().font.width(this.title.getString()), this.y + Minecraft.getInstance().font.lineHeight);
		}
