...
import com.createcivilization.capitol.old.constants.CommonConstants;
import com.createcivilization.capitol.old.gui.base.BookScreen;
import com.createcivilization.capitol.old.gui.base.Interactable;
...
public class CreateTeamScreen extends BookScreen {
	...
	protected void init() {
		...
		BookMenu.TextInput color = new BookMenu.TextInput(Component.literal("Team Color"), this.leftPos + 20, 83, CommonConstants.Colors.colors.keySet().stream().toList());
