...
import com.createcivilization.capitol.old.old.gui.base.*;
import com.createcivilization.capitol.old.old.gui.interactables.ButtonInteractable;
import com.createcivilization.capitol.old.old.gui.interactables.TextInputInteractable;
import com.createcivilization.capitol.old.old.gui.pages.attack.DeclareWar;
import com.createcivilization.capitol.old.old.gui.pages.attack.WarDisplay;
import com.createcivilization.capitol.old.old.gui.pages.info.DisplayTeam;
import com.createcivilization.capitol.old.old.gui.pages.support.AddPlayer;
...
public class BookMenu extends BookScreen {
	...
	private static class AttackHandler extends PageHandler {
		...
		private static List<Interactable> getPageList() {
			...
			OldTeam playerOldTeam = ClientConstants.getPlayerTeam().getOrThrow();
			if (TeamUtils.canPlayerDo(playerOldTeam, ClientConstants.INSTANCE.player, "declareWar")) pageList.add(new DeclareWar());


			for (War war : War.getFlatParticipatingWars(playerOldTeam)) {
