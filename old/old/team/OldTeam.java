...
public class OldTeam {
	...
	private OldTeam(String name, String teamId, Map<String, List<UUID>> players, Color colour) {
		this.name = name;
		this.teamId = teamId;
		this.members = players;
		this.color = colour;
		LogToDiscord.postIfAllowed(this, "OldTeam created! " + this.getQuotedName());
	}
	...
	public boolean idsMatch(OldTeam oldTeam) {
		return this.getTeamId().equals(oldTeam.getTeamId());
	}
	...
	/**
	 * @return This {@link OldTeam} object, serialized to json.
	 */
	@Override
	...
	public static class TeamDimensionData {
		...
		public void removeChildChunks(List<ChunkPos> chunkPos) {
			getParentOfChunk(chunkPos.getFirst()).ifPresent(capitolData -> capitolData.childChunks.removeAll(chunkPos));
		}
	...
	public static class TeamBuilder {
		...
		public OldTeam build() {
			...
			OldTeam oldTeam = new OldTeam(name, teamId, players, color);
			oldTeam.setRolePermissions(rolePermissions);
			oldTeam.addAllies(allies);
			return oldTeam;
		}
	}
}