package com.createcivilization.capitol.old.old.command.custom.abstracts;
...
public abstract class AbstractPlayerCommand extends AbstractCommand {
	...
	// What the user must have to do the command, i.e "be a player", "be a player and an operator", "be a player and in a receivingOldTeam"
