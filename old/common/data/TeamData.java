package com.createcivilization.capitol.old.common.data;

import com.createcivilization.capitol.old.common.assets.Request;
import com.createcivilization.capitol.old.common.assets.Role;
import com.createcivilization.capitol.old.common.assets.Status;
...
import com.createcivilization.capitol.old.server.utils.GsonUtil;
...
/**
 * Data manager for all relevant oldTeam data.
 */
public class TeamData {
	...
	public static class SmartUtils {
		public static Status createTeam(Request request, String name) {
			...
			return new Status(
				true,
				"OldTeam " + name + " successfully created.",
				null
			);
		}
		...
		public static Status disbandTeam(Request request, @Nullable UUID teamId) {
			...
			if (origin.equals(ServerConstants.SERVER_UUID))
				...
				return new Status(
					false,
					"You must be the owner of the oldTeam to disband it!",
					null
				);

			return new Status(
				true,
				"OldTeam successfully disbanded.",
				null
			);
		}
	}
	...
	public static class DataUtils {
		...
		public static void saveData() throws IOException {
			...
			if (!DATA_FILE.exists()) {
				if (!DATA_FILE.createNewFile()) throw new IOException("OldTeam Data file could not be made.");
				else {
