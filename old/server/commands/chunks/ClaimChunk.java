 ...
 * Claims a chunk
 * <p>
 *     If ran by a player it will claim the current chunk to the player's oldTeam
 * <p>
 *     If ran by the server it'll allow to set teamid, dimension, x and z of a chunkpos to claim it in name of a oldTeam
 */
